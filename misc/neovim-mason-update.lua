-- Headless helper for neovim.sh: upgrade every already-installed mason.nvim
-- package to its latest version. Run via:
--   nvim --headless -c "luafile setup_scripts/nvim-mason-update.lua" -c "qa"
